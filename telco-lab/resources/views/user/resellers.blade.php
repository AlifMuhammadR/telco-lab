    ...
    <div class="company-section py-5">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="company-card" onclick="toggleDetail(this)">
                        <img src="{{ asset('assets/images/brand-telkom.png') }}" class="img-fluid"
                        ...
                        <div class="detail-content">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-info">
                                    <h6>Andi Wijaya</h6>
                                    <p><i class="fas fa-phone-alt"></i> 0813-xxxx-xxxx · <i class="fas fa-envelope"></i>
                                        andi@tekn.com</p>
                                </div>
                            </div>
                            <!-- Kontak Budi Santoso -->
                            <div class="contact-item">
                                ...
                                <div class="contact-info">
                                    <h6>Budi Santoso</h6>
                                    <p><i class="fas fa-phone-alt"></i> 0812-xxxx-xxxx · <i class="fas fa-envelope"></i>
                                        budi@tekn.com</p>
                                </div>
                            </div>
                            <!-- Customer Service -->
                            <div class="contact-item">
                                ...
                                <div class="contact-info">
                                    ...
                                    <p><i class="fas fa-phone-alt"></i> 1500-123 · <i class="fas fa-envelope"></i>
                                        cs@tekn.com</p>
                                </div>
                            </div>
                            <!-- Alamat -->
                    ...
                    <div class="company-detail">
                        <div class="detail-content">
                            <div class="contact-item">
                                ...
                                <div class="contact-info">
                                    <h6>Rina Kartika</h6>
                                    <p><i class="fas fa-phone-alt"></i> 0815-xxxx-xxxx · <i class="fas fa-envelope"></i>
                                        rina@globaltech.com</p>
                                </div>
                            </div>
                            <div class="contact-item">
                    ...
                    <div class="company-detail">
                        <div class="detail-content">
                            <div class="contact-item">
                                ...
                                <div class="contact-info">
                                    <h6>Bayu Aji</h6>
                                    <p><i class="fas fa-phone-alt"></i> 0814-xxxx-xxxx · <i class="fas fa-envelope"></i>
                                        bayu@infra.com</p>
                                </div>
                            </div>
                            <div class="contact-item">
            ...
            <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="company-card" onclick="toggleDetail(this)">
                        <img src="{{ asset('assets/images/brand-huawei-1.png') }}" class="img-fluid"
                            alt="Huawei Partner">
                        <div class="company-info">
