...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
        ...
        <link rel="icon" type="image/x-icon" href="{{ asset('assets/images/link-hyperlink-icon.png') }}" />
		<title>TELCO LAB</title>
        <style>
.hero {
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>About Us</h1>
								<p class="mb-4">Informasi perangkat jaringan (Network Devices) yang menyediakan data lengkap.</p>
								<p><a href="" class="btn btn-secondary me-2">Shop Now</a><a href="#" class="btn btn-white-outline">Explore</a></p>
							</div>
						</div>
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="{{ asset('assets/images/huawei.png') }}" class="img-fluid hero-device">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
						<a class="product-item" href="cart.html">
							...
							<span class="icon-cross">
								<img src="{{ asset('assets/images/cross.svg') }}" alt="Img" class="img-fluid">
							</span>
						</a>
					</div>
					<!-- End Column 4 -->
